...
LIST_OF_COLS_TO_GROUP_ON = [
  ...
  [COL_ALGO_MEDICAL_TERM, COL_ALGO_MEDICAL_GROUP]
] 
...
COL_STATS_LEVEL = COL_ALGO_MEDICAL_GROUP 
# For specific diags, COL_STATS_LEVEL must be an element among: COL_ICD_MEDICAL_TERM, COL_ICD_MEDICAL_GROUP, COL_ALGO_MEDICAL_TERM, COL_ALGO_MEDICAL_GROUP, COL_ALGO_MEDICAL_BLOCK (by descending precision)
